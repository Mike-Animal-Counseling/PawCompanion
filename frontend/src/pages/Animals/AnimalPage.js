...
export default function AnimalPage() {
    ...
    return (<>
      { !animal? (<NotFound message="Animal Not Found!" linkText="Go Back To HomePage" />
    ) : (
        <div className={classes.container}>
          ...
          <div className={classes.details}>
            <div className={classes.header}>
                ...
                <span className={`${classes.favorite} ${animal.favorite? '' : classes.not}`}>
                  ♥
                </span>
            </div>
              ...
              <div className={classes.tags}>
                {animal.tags && (
                    <Tags tags={animal.tags.map(tag => ({name: tag}))}  forAnimalPage={true}/>
                )}
              </div>
